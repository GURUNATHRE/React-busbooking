...
function Paymentprocess() {
    ...
    const { details, Price } = location.state || {};
    ...
    useEffect(() => {
        const fetchbus = async () => {
            try {
                ...
                console.log("p bus", response.data)
            } catch (error) {
    ...
    // coupons fetching whene user is loged in that means token exist 
    useEffect(() => {
    ...
    // useeffect for how many len details
    useEffect(() => {

        if (details && details.length > 0) {

            const passengerList = details.map(() => ({
                name: "",
                age: "",
                gender: ""
            }));

            setTravelers(passengerList);
        }
    ...
    const Totalfairprice = Price - Number(appliedCoupon?.amount) + 10;
    console.log("after coupon:", Totalfairprice)
        ...
        <div className="min-vh-200 booking-page">
            ...
            <div className="container py-5">
                <div className="row g-4">
                    {/* Left Column: Journey & Traveler Details */}
                        ...
                        {businfo && (
                            <div className="card border-0 shadow-lg mb-4 overflow-hidden rounded-4">
                                ...
                                <div className="card-body p-0">
                                    ...
                                    <div className="p-4 bg-white">
                                        <div className="row align-items-center">
                                            <div className="col-md-4 mb-3 mb-md-0 border-end-md">
                                                <small className="text-muted text-uppercase fw-bold ls-1">Operator</small>
                                            ...
                                            <div className="col-md-8">
                                                <div className="d-flex justify-content-between align-items-center px-lg-3">
                                                    ...
                                                    <div className="text-center">
                                                        ...
                                                        <div className="text-muted x-small text-uppercase">Departure</div>
                                                    </div>

                                                    {/* Animated Bus Icon Connector */}
                                                    ...
                                                    <div className="text-center">
                                                        ...
                                                        <div className="text-muted x-small text-uppercase">Arrival</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    {/* Bottom Info Bar - Ticket Stub Style */}
                                    <div className="bg-light border-top border-2 border-dashed border-white p-3 px-4">
                                        <div className="row g-2">
                                            <div className="col-sm-4 d-flex align-items-center">
                                                ...
                                                <div className="text-truncate">
                                                    <div className="text-muted x-small fw-bold text-uppercase">Origin</div>
                                            ...
                                            <div className="col-sm-4 d-flex align-items-center">
                                                ...
                                                <div className="text-truncate">
                                                    <div className="text-muted x-small fw-bold text-uppercase">Destination</div>
                                            ...
                                            <div className="col-sm-4 d-flex align-items-center">
                                                ...
                                                <div>
                                                    <div className="text-muted x-small fw-bold text-uppercase">Service</div>
                            ...
                            <div className="card-body p-4">
                                <div>
                                        ...
                                        <div key={index} className="p-4 mb-3 border rounded-3 bg-white">
                                            ...
                                            <div className="row g-3">
                                                ...
                                                <div className="col-md-3">
                                                    ...
                                                    <select className="form-select form-select-lg border-2" onChange={(e) => handleInputChange(index, "gender", e.target.value)}>
                                    ...
                                    <div className="col-md-3 mt-5">
                                        {!submitted && <button className="btn custom-btn-brown btn-lg w-100 fw-bold shadow-sm" onClick={handleSubmit}>
                                            Submit
                                        </button>}
                                    </div>
                                    {submitted &&
                                            ...
                                            <div key={index} className="passenger-box p-3 mb-3 border border-2 rounded-4 shadow-sm bg-white mt-4">
                                                <div className="row align-items-center">
                                                    ...
                                                    <div className="col-md-5 d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <p className="text-muted x-small text-uppercase mb-0 fw-bold tracking-wider">
                                                                Passenger Name
                                                            </p>
                                ...
                                <button className="btn btn-primary btn-lg w-100 py-3 mt-3 fw-bold shadow">
                            ...
                            <div className="card-body p-4">
                                ...
                                <div className="d-flex justify-content-between mb-2">
                                    ...
                                    <span className="fw-bold">
                                        {details.map((item) => item.seat.seat_no).join(", ")}
                                    </span>
                                </div>
                                ...
                                <div className="d-flex justify-content-between">
                                    ...
                                    <h5 className="fw-bold text-success">${Price - Number(appliedCoupon?.amount || 0) + 10}</h5>
                                </div>
                                    ...
                                    coupons.map((coupon) => (
                                        <div key={coupon.id} className="p-3 mb-3 border border-dashed rounded-3 bg-light d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <div className="text-success small">{coupon.Couponcode} <span>code_name</span></div>
                                            </div>
                                            <button
